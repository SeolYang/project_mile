...
namespace Mile
{
	...
	namespace IMGUIStyle
	{
		...
		static inline void ApplyCherry()
		{
...
#define _TEXT_COL_(v) ImVec4(0.860f, 0.930f, 0.890f, v)
		...
		static inline void ApplyClassicSteam()
		{
			ImVec4* colors = ImGui::GetStyle().Colors;
		...
		static inline void ApplyGoldBlack()
		{
			ImGuiStyle* style = &ImGui::GetStyle();
			ImVec4* colors = style->Colors;
	...
	static inline void SetupImGuiStyle(EGUIStyle guiStyle)
	{
		switch (guiStyle)
		{
		case Mint:
